...
<aside class="admin-side">
  <div class="admin-side__brand">
    <div class="admin-side__brand-seal">WV</div>
    <div class="admin-side__brand-text">
      <div class="admin-side__brand-name">Desktop Assistant</div>
      <div class="admin-side__brand-sub">Chamber Console</div>
    </div>
  </div>
  <nav class="admin-nav">
    ...
    <div class="admin-nav__group">
      ...
      <a href="newsletter.html" class="${active==='newsletter'?'active':''}">✉️ Newsletter</a>
    </div>
    <div class="admin-nav__group">
  ...
  <div class="admin-side__user">
    <div class="admin-side__user-avatar">DR</div>
    <div>
      <div class="admin-side__user-name">Diane R.</div>
      <div class="admin-side__user-role">Executive Director</div>
    </div>
  </div>
</aside>`;
  }
...
<div class="ai-assistant" id="ai-assistant">
  ...
  <div class="ai-assistant__body" id="ai-body">
    <div class="ai-msg ai-msg--bot">
      Hi Diane — I'm your AI assistant. I can draft content, manage approvals, look up members, schedule events, send newsletters, and answer any operational question. What do you need?
    </div>
  </div>
